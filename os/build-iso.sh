...
for service in kodi-os-storage-init.service kodi-os-session.service kodi-os-firstboot.service kodi-os-recovery.service \
  kodi-os-gaming-init.service kodi-os-gaming-check.service kodi-os-game-launcher.service kodi-os-controller-init.service kodi-os-device-watch.service \
...
for script in firstboot.sh kodi-os-hardware.sh kodi-os-session-wrapper.sh kodi-os-recovery \
  kodi-os-storage-init kodi-os-storage-check kodi-os-gaming-init kodi-os-gaming-check kodi-os-game-launcher \
  kodi-os-controller-init kodi-os-device-watch kodi-os-network-init kodi-os-network-watch kodi-os-healthcheck kodi-os-app-launcher kodi-os-update; do
