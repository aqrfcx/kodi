...
for cmd in lb sha256sum find tee; do
...
mkdir -p config/package-lists config/includes.chroot/etc/systemd/system config/includes.chroot/etc/default/grub.d config/includes.chroot/etc/calamares config/includes.chroot/usr/sbin config/hooks/live

cp "$OS_DIR/package-lists/kodi-os.list.chroot" config/package-lists/
for unit in kodi-os-session.service kodi-os-firstboot.service kodi-os-recovery.service kodi-os-gaming-init.service kodi-os-controller-init.service kodi-os-network-init.service kodi-os-healthcheck.service kodi-os-update-check.service; do
  cp "$OS_DIR/$unit" "config/includes.chroot/etc/systemd/system/$unit"
done
cp "$OS_DIR/systemd/kodi-os.target" config/includes.chroot/etc/systemd/system/
for script in firstboot.sh kodi-os-hardware.sh kodi-os-session-wrapper.sh kodi-os-recovery kodi-os-storage-init kodi-os-gaming-init kodi-os-controller-init kodi-os-network-init kodi-os-healthcheck kodi-os-app-launcher kodi-os-update-check; do
