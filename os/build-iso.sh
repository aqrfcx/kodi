...
mkdir -p config/package-lists config/includes.chroot/etc/systemd/system \
  ...
  config/includes.chroot/usr/sbin config/hooks/live
...
for service in kodi-os-session.service kodi-os-firstboot.service kodi-os-recovery.service \
  ...
  kodi-os-healthcheck.service kodi-os-update.service; do
...
for script in firstboot.sh kodi-os-hardware.sh kodi-os-session-wrapper.sh kodi-os-recovery \
  kodi-os-storage-init kodi-os-gaming-init kodi-os-controller-init kodi-os-network-init \
  kodi-os-healthcheck kodi-os-app-launcher kodi-os-update; do
